...
🎯 I'm a **Software Developer** passionate about technology, clean code, and solving real-world problems through software.

---

### 🧠 About Me

- 💼 I design, build, and maintain scalable backend systems and cloud-based solutions.
- 🛠️ I work with modern programming languages and frameworks across backend, frontend, infrastructure, and testing.
- ☁️ I deploy to the cloud with confidence using infrastructure as code and containerization.
- 🧪 I'm committed to code quality, observability, and automation.
- 🔄 I enjoy working with event-driven architectures and microservices.
...
If you want to talk about tech, software development, or interesting challenges, feel free to reach out!

📩 [LinkedIn](https://www.linkedin.com/in/almeidaerico/)
